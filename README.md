...
```mermaid
flowchart TD
    %% Subgrafo de Evolución
    subgraph Evolution["Evolución del SEO al OSO 🔄"]
        direction TB
        SEO["🎯 SEO Tradicional<br/>- Optimiza solo para buscadores<br/>- Enfoque en keywords<br/>- Métricas: rankings, CTR"]
        OSO["🌟 OSO: Omnisearch Optimization<br/>- Optimización omnicanal<br/>- Enfoque holístico<br/>- Métricas multiplataforma"]
        SEO -. "Evoluciona por cambios en<br/>comportamiento del usuario" .-> OSO
    end
    
    %% Subgrafo de Plataformas
    subgraph Platforms["Ecosistema Actual 🌐"]
        direction TB
        Buscadores["🔍 Motores de Búsqueda<br/>- Google<br/>- Bing<br/>- DuckDuckGo<br/>KPI: Rankings SERP"]
        Redes["📱 Redes Sociales<br/>- Instagram<br/>- TikTok<br/>- LinkedIn<br/>KPI: Engagement"]
        Video["🎥 Plataformas Video<br/>- YouTube<br/>- TikTok<br/>- Vimeo<br/>KPI: Visualizaciones"]
        Chats["🤖 IAs Generativas<br/>- ChatGPT<br/>- Gemini<br/>- Perplexity<br/>KPI: Citación en respuestas"]
    end
    
    %% Conexiones con OSO
    OSO -->|"Optimiza contenido y formato"| Buscadores
    OSO -->|"Adapta visual y social"| Redes
    OSO -->|"Optimiza multimedia"| Video
    OSO -->|"Estructura datos para IA"| Chats
```
...
flowchart TD
    %% Subgrafo de Evolución
    subgraph Evolution["Del SEO al AEO 🔄"]
        direction TB
        SEO["🎯 SEO Tradicional<br/>- Optimiza para listados SERP<br/>- Múltiples intenciones<br/>- Busca tráfico web<br/>- Competencia por clicks"]
        AEO["🎯 AEO: Answer Engine Optimization<br/>- Optimiza para respuestas directas<br/>- Enfoque en consultas informativas<br/>- Busca ser fuente citada<br/>- Competencia por visibilidad en IA"]
        SEO -. "Evoluciona por auge de<br/>búsquedas zero-click y IA" .-> AEO
    end
    
    %% Subgrafo de Características
    subgraph Features["Características Diferenciadoras 🔍"]
        direction TB
        Intenciones["🎯 Intención de Búsqueda<br/>SEO: Informativo, Acción, Navegación...<br/>AEO: Informativo básico, Informativo detallado"]
        Formato["📄 Formato de Contenido<br/>SEO: Optimizado para lectura<br/>AEO: Estructurado para extracción"]
        Metricas["📊 Métricas de Éxito<br/>SEO: CTR, Posición SERP<br/>AEO: Citaciones, Snippets"]
    end
    
    %% Conexiones
    SEO -->|"Enfoque: Rankings"| Intenciones
    AEO -->|"Enfoque: Respuestas"| Intenciones
    SEO -->|"Página completa"| Formato
    AEO -->|"Datos estructurados"| Formato
    SEO -->|"Mide clics"| Metricas
    AEO -->|"Mide citaciones"| Metricas
```
...
```mermaid
flowchart LR
    %% Subgrafo del Proceso GEO
    subgraph Process["Proceso GEO y Desafíos 🤖"]
        direction TB
        Usuario["👤 Usuario<br/>Realiza consulta"]
        LLM["🧠 LLM/IA Generativa<br/>- Procesa consulta<br/>- Analiza fuentes<br/>- Genera respuesta"]
        Fuentes["📚 Fuentes de Contenido<br/>- Sitios web<br/>- Documentos<br/>- Bases conocimiento<br/>- Datasets"]
    end

    %% Subgrafo de Estrategias GEO
    subgraph Strategies["Estrategias GEO 🎯"]
        direction TB
        Estructura["📋 Contenido Estructurado<br/>- Schema.org<br/>- JSON-LD<br/>- Metadatos semánticos"]
        Autoridad["⭐ Señales de Autoridad<br/>- Citaciones académicas<br/>- Referencias verificables<br/>- Expertise demostrado"]
        Contexto["🔍 Contexto Rico<br/>- Información completa<br/>- Relaciones semánticas<br/>- Datos estructurados"]
    end

    %% Flujo principal
    Usuario --> LLM
    LLM --> |"Busca y analiza"| Fuentes
    Fuentes --> |"Proporciona datos"| LLM
    LLM --> |"Respuesta sintetizada"| Usuario

    %% Conexiones con estrategias
    Estructura --> |"Facilita extracción"| Fuentes
    Autoridad --> |"Aumenta credibilidad"| Fuentes
    Contexto --> |"Mejora comprensión"| Fuentes
...
```mermaid
flowchart TD
    %% Subgrafo de Entrada y Dispositivo
    subgraph InputDevice["Dispositivo de Entrada 🎤"]
        Usuario[("Usuario")]
        Device["Dispositivo IoT<br/>- Smartphone<br/>- Smart Speaker<br/>- Asistente Virtual"]
        AudioSignal["Señal de Audio<br/>- Frecuencia: 20Hz-20kHz<br/>- SNR > 20dB<br/>- Muestreo: 16kHz"]
    end

    %% Subgrafo de Procesamiento de Señal
    subgraph SignalProcessing["Procesamiento de Señal 🔄"]
        VAD["VAD<br/>(Detección de Actividad<br/>de Voz)<br/>- Umbral energía<br/>- ML clasificación"]
        NoiseReduction["Reducción de Ruido<br/>- Filtrado espectral<br/>- Beam-forming<br/>- Cancelación eco"]
        FeatureExtraction["Extracción Features<br/>- MFCC<br/>- Filterbank<br/>- Pitch tracking"]
    end

    %% Subgrafo de Reconocimiento
    subgraph Recognition["Sistema ASR 🧠"]
        Acoustic["Modelo Acústico<br/>- DNN/HMM<br/>- CTC/RNN<br/>- Transformers"]
        Language["Modelo de Lenguaje<br/>- N-grams<br/>- BERT/GPT<br/>- Vocab: 100k+"]
        IntentRecog["Reconocimiento<br/>de Intención<br/>- NER<br/>- Semantic parsing"]
    end

    %% Subgrafo de Optimización
    subgraph Optimization["Estrategias SEO 📈"]
        Schema["Schema.org<br/>- SpeakableSpecification<br/>- WebPage<br/>- FAQPage"]
        NLPOpt["Optimización NLP<br/>- Embeddings<br/>- Entidades<br/>- Taxonomías"]
        LocalOpt["SEO Local<br/>- GeoJSON-LD<br/>- Local Business<br/>- Near me queries"]
    end

    %% Subgrafo de Respuesta
    subgraph Response["Sistema de Respuesta 💬"]
        Search["Motor Semántico<br/>- Vector search<br/>- Knowledge Graph<br/>- Ranking model"]
        NLG["Generación NL<br/>- Templating<br/>- GPT/T5<br/>- Style transfer"]
        TTS["Síntesis de Voz<br/>- FastSpeech 2<br/>- WaveNet<br/>- Unit selection"]
    end
    ...
    AudioSignal --> VAD
    VAD --> NoiseReduction
    NoiseReduction --> FeatureExtraction
    FeatureExtraction --> Acoustic
    Acoustic --> Language
    Language --> IntentRecog
    IntentRecog --> Search

    %% Conexiones de Optimización
    Schema --> Search
    NLPOpt --> Search
    LocalOpt --> Search
    Search --> NLG
...
```mermaid
flowchart TD
    %% Subgrafo de Entrada de Usuario
    subgraph UserInput["Entrada de Usuario 👤"]
        Query["Consulta Natural<br/>- Preguntas completas<br/>- Lenguaje coloquial<br/>- Intención conversacional"]
        Context["Contexto de Usuario<br/>- Historial de diálogo<br/>- Preferencias<br/>- Ubicación"]
    end

    %% Subgrafo de Procesamiento NLP
    subgraph NLPEngine["Motor NLP 🧠"]
        Intent["Análisis de Intención<br/>- BERT/RoBERTa<br/>- Clasificación<br/>- Confianza >0.85"]
        Entity["Extracción Entidades<br/>- NER<br/>- Knowledge Graph<br/>- Resolución"]
        Dialog["Estado de Diálogo<br/>- Contexto actual<br/>- Referencias previas<br/>- Memory tokens"]
    end

    %% Subgrafo de Contenido
    subgraph Content["Gestión de Contenido 📄"]
        Index["Índice Semántico<br/>- Embeddings<br/>- Vector DB<br/>- Taxonomía"]
        QA["Base Q&A<br/>- FAQPage markup<br/>- Snippets<br/>- Variaciones"]
        Context["Contexto Semántico<br/>- Topic Graph<br/>- Relaciones<br/>- Jerarquías"]
    end

    %% Subgrafo de Respuesta
    subgraph Response["Generación de Respuesta 💬"]
        Template["Plantillas Dinámicas<br/>- Personalización<br/>- A/B testing<br/>- Tone of voice"]
        NLG["Generación NL<br/>- GPT/T5<br/>- Paráfrasis<br/>- Adaptación"]
        Metrics["KPIs<br/>- Satisfacción<br/>- Resolución<br/>- Engagement"]
    end
    ...
    Template --> NLG
    NLG --> Metrics
    Metrics -->|"Retroalimentación"| Query

    %% Conexiones de Contexto
    Context -->|"Enriquece"| Intent
    Context -->|"Alimenta"| Dialog
    Context -->|"Personaliza"| Template
```
...
```mermaid
flowchart TD
    %% Subgrafo de Entidades y Tipos
    subgraph EntityTypes["Tipos de Entidades 🏷"]
        direction TB
        Local["Entidades Locales 🏢<br/>- Empresas colombianas<br/>- Lugares turísticos<br/>- Barrios y zonas"]
        Person["Personas 👥<br/>- Influenciadores<br/>- Empresarios<br/>- Personajes históricos"]
        Product["Productos 🛍<br/>- Artesanías<br/>- Gastronomía<br/>- Servicios locales"]
        Event["Eventos 📅<br/>- Festivales<br/>- Ferias<br/>- Temporadas"]
    end

    %% Subgrafo de Procesamiento Semántico
    subgraph Semantic["Procesamiento Semántico 🧠"]
        direction TB
        KG["Knowledge Graph<br/>- Grafo de conocimiento<br/>- Jerarquías<br/>- Relaciones"]
        NER["Reconocimiento NER<br/>- spaCy es_core_news_lg<br/>- Modelo colombiano<br/>- Precisión >90%"]
        Context["Contexto Regional<br/>- Dialectos<br/>- Cultura<br/>- Geografía"]
    end

    %% Subgrafo de Marcado y Estructura
    subgraph Markup["Marcado Estructurado 📝"]
        Schema["Schema.org<br/>- LocalBusiness<br/>- Organization<br/>- Place"]
        JSON_LD["JSON-LD<br/>- Datos estructurados<br/>- Microdatos<br/>- RDFa"]
        Links["Enlaces Semánticos<br/>- Wikidata<br/>- DBpedia<br/>- Datos abiertos CO"]
    end

    %% Subgrafo de Optimización
    subgraph SEO["Optimización SEO 🎯"]
        SERP["Resultados SERP<br/>- Rich snippets<br/>- Knowledge panel<br/>- Local pack"]
        Intent["Intención Usuario<br/>- Informacional<br/>- Transaccional<br/>- Navegacional"]
        Metrics["Métricas<br/>- CTR por región<br/>- Engagement local<br/>- Conversiones"]
    end

    %% Conexiones Principales
    EntityTypes -->|"Alimenta"| KG
    KG -->|"Enriquece"| NER
    NER -->|"Identifica"| Schema
    Schema -->|"Estructura"| JSON_LD
    JSON_LD -->|"Mejora"| SERP
    Context -->|"Contextualiza"| Intent
    Links -->|"Conecta"| KG

    %% Conexiones de Optimización
    SERP -->|"Impacta"| Metrics
    Intent -->|"Guía"| Metrics
    Context -->|"Refina"| EntityTypes
```
